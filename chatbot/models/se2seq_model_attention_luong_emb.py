...
class  Seq2seq_att_luong(BasicModel):
    ...
    def _build_graph(self):
        ...
        with tf.device('/gpu:0'):
            ...
            emb =  tf.concat([emb_train, emb_pretrained], axis =0)
            ...
            with tf.name_scope("rnn-encoder"):
                lstm_encoder = tf.contrib.rnn.DropoutWrapper(tf.contrib.rnn.MultiRNNCell([tf.contrib.rnn.GRUCell(self.rnn_size)]*2,
            ...
            with tf.name_scope("rnn_decoder"):
                lstm_decoder = tf.contrib.rnn.DropoutWrapper(tf.contrib.rnn.MultiRNNCell([tf.contrib.rnn.GRUCell(self.rnn_size)]*2,
                                                             output_keep_prob = self.keep_prob))
